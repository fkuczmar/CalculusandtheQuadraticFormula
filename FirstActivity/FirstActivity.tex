...
Units could play a more prominent role in our classes, particularly in places where they seem not to play any role at all.
...
Drag the slider $s$ to move the point $P$ along the parabola $y=ax^2 +bx+c$ and check that the length of segment $AB$ remains unchanged.
