...
\item The key now is to interpret the meaning of this first term geometrically. Here's a little hint. Write this term as
\[
  \Delta x = - \frac{b}{2a}
\]
and recall a math department meeting a few years ago when Trevor talked about two normal lines to a parabola and the limit of their intersection point as one line approached the other.
...
\item To start on the second, we should first think about its numerator,
\[
  \sqrt{b^2 - 4ac}.
\]
What are its units? And can you think of a geometric interpretation relevant to a 151 class?
