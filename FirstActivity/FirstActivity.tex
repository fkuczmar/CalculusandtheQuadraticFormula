...
\maketitle
 ...
 Here we offer several interpretations of the quadratic formula from the perspectives of differential and integral calculus.
...
\begin{equation}
 ...
 \end{equation}
 The coordinates $x,y$ and the constant term $c$ have dimensions of length. The coefficient $b$ is dimensionless and gives the slope of the tangent line at the $y$-intercept $Q(0,c)$. Since the product $ax^2$ is a length, so is the reciprocal $a^{-1}$ of the leading coefficient. This reciprocal has several interpretations, each describing the parabola's size. One is related to the parabola's radius of curvature $(2a)^{-1}$ at the vertex and another to the focal length, $(4a)^{-1}$. 

But a third interpretation, our focus here, is encoded in the quadratic formula. It also plays a key role in the solution to the following problem.
...
\begin{onlineOnly}
    \begin{center}
\desmos{dkbavb5xzf}{450}{600} 
\end{center}
\end{onlineOnly}

\href{https://www.desmos.com/calculator/dkbavb5xzf}{151: Normals to Parabola 2}
