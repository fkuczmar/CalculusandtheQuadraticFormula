...
Figure ?? shows $P^*$ at a transition point where it crosses the rolling tangent. But Robinson gives a more insightful description.

\begin{theorem21}
The transition points divide the segments tangent to the ellipse, those with their endpoints on the extended axes, into segments $P^*B = b+a$ and $P^*A = b-a$, with lengths respectively equal to the semi-major $OX$ and semi-minor axes $OY$ (see Figure ???).
\end{theorem21}
...
The other half is a second trammel (Figure ??). It slides along the same axes as the the one in Figure ?? and traces the same ellipse. It also has the same tracing point. But now $P^*$ lies \emph{between} the pins, at distances $P^* R_2 = P^* R_1 = b+a$ and $P^* P_2 = P^* P_1 = b-a$ from them. So the two arms cut the axes at the same angle ($\angle R_1 \cong\angle R_2$ and $\angle P_1\cong \angle P_2$) and the arms rotate at the same rate as $P^*$ traces the ellipse. But while the arm of the first trammel is never tangent to the ellipse, the arm of the second is tangent to the ellipse exactly four times. And these four points of tangency are the transistion points separating the same and opposite-side arclengths of the ellipse.
...
Figure ?? helps explain why with two new circles. The first, ${\cal C}_2$, lies on diameter $\overline{P_2R_2}$ and has radius $b$. The second, ${\cal C}_2^\prime$, is centered at $O$ and has radius $2b$. Set the figure in motion and you'll see ${\cal C}_2$ rolling around the inside of ${\cal C}_2^\prime$ at the same rate as ${\cal C}_1$ rolls around ${\cal C}_1^\prime$. The point $P^*$, at rest in the reference frames of both rolling circles, traces the ellipse as a roulette in two ways; as a point attached $b=C_1P^*$ units from the center of the circle ${\cal C}_1$ having radius $a=C_1Q_1$ and as a point $a=C_2P^*$ units from the center of ${\cal C}_2$ with radius $b=C_2Q_2$.

Now because the radius of each rolling circle is half the radius of its partner, (\ref{Eq:RollAngle}) implies the vertical lines through their centers (not shown) bisect the angles $\angle Q_1C_1P^*$ and $\angle Q_2C_2P^*$. It follows that $\overline{C_1P^*}\parallel \overline{C_2Q_2}$ and $\overline{C_1Q_1}\parallel \overline{C_2P^*}$. So $\angle P^*C_1Q_1\cong \angle Q_2C_2P^*$ and $\Delta P^* C_1Q_1 \cong \Delta Q_2C_2P^*$ (SAS).

%Because the trammel arms $\overline{P_1R_1}$ and ${\cal P_2R_2}$ make the same angles with the axes, ${\cal C}_1$ and ${\cal C}_2$ turn at the same rate in the opposite sense. This


You might also notice $P^*$ and the instantaneous centers of rotation $Q_1$ and $Q_2$ of the rolling circles are always colinear. 
Accepting this for the moment is almost enough to verify Robinson's description of the transition points. The missing fact is that  trammel $\overline{P_2Q_2}$ is tangent to the ellipse exactly when the rotation arm $\overline{Q_2P^*}$ is perpendicular to the trammel. These two facts imply Robinsson's description since $P^*$ crosses the rolling tangent


Look back at Figure ?? and 
...
%, you'll see ${\cal C}_2$ rolling around the inside of ${\cal C}_2^\prime$ at the same rate with the opposite sense. So the point $P^*$, at rest in the reference frames of both rolling circles, traces the ellipse in two way; attached $b$ units from the center of ${\cal C}_1$ (radius $a$), and $a$ units from then center of ${\cal C}_2$ (with radius $b$). This double-generation of the ellipse, ...


%As the ends $P_2$, $R_2$ of the second trammel slide along the axes, the circle ${\cal C}_2$ on diameter $\overline{P_2R_2}$ with radius $b$ rolls around the inside of the circle ${\cal C}_2^\prime$ centered at $O$ with radius $2b$.  
...
\item $\overline{C_1P_1}$ and $\overline{R_2P_2}$ are always parallel, as are $\overline{C_2Q_2}$ and $\overline{R_1P_1}$

\item The arm $\overline{P_2R_2}$ of Trammel 2 is tangent to the ellipse exactly when $\overline{Q_2P^*}$ is perpendicular to $\overline{P_2R_2}$.
\end{enumerate}

It follows that  the four points of tangency are the transition points. This is because $\overline{Q_1P^*}$ is perpendicular to $\overline{C_1Q_1}$, at the points of tangency.   

As the trammels slide in tandem, the second $\overline{P_2R_2}$ is the diameter of a circle (center $C_2$) with radius $b$ that rolls around the inside of a circle (center $O$) with radius $2b$.  

Trammel arm $\overline{P_2Q_2}$ is the diameter of a circle with radius $2b$ rolling around the inside of a circle with radius $4b$.


To see why, let's focus our attention on this second trammel. With the coordinate system of Figure ?? and $\phi$ the marked angle between the arm and the $x$-axis, $P^*$ has coordinates 
\[
...
This shows $P^*$ sweeps out an ellipse with semi-major/minor . To find the arm's position when it is tangent to the ellipse in the first quadrant, imagine the arm in motion. The arm is then tangent to the ellipse exactly when $P^*$ is moving parallel to the arm, or when $dy/dx = -\tan\phi$. Some calculus and algebra then shows the arm is tangent to the ellipse exactly once, when $P^*$ has coordinates
\[
   (x,y) = (2b\cos^3 \phi, 2b\sin^3\phi).
\]

We can avoid these computations by appealing to the center of curvature. Imagine the 
...
is one I like to give my calculus students. It's really just a version of the question that relates the speeds of the top and bottom ends of a sliding ladder. The key to its solution is 
