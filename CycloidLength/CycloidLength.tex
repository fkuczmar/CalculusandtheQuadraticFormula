...
\section{Ladders, Astroids, and Ellipses}
...
Kalman's idea is to reverse the question. He fixes the ladder's length $L$ and asks instead for the widths of all pairs of hallways that allow the passage of a ladder of maximum length $L$. This amounts to 
