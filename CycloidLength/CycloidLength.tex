...
Figure ?? below suggests why. We've added two circles (green) to Figure ??; ${\cal C}_2$ on diameter $\overline{P_2R_2}$ with radius $b$ and ${\cal C}_2^\prime$ centered at $O$ with radius $2b$. Set the figure in motion and as ${\cal C}_1$ rolls around ${\cal C}_1^\prime$, you'll see ${\cal C}_2$ rolling around the inside of ${\cal C}_2^\prime$ at the same rate.


Three key points:

\begin{enumerate}
\item The tracing point $P^*$ and the instantaneous centers of rotation $Q_1$ and $Q_2$ of the rolling circles stay colinear.

\item The arm $\overline{P_2R_2}$ of Trammel 2 is tangent to the ellipse at four points, when $\overline{Q_2P^*}$ is perpendicular to $\overline{P_2R_2}$.
\end{enumerate}

It follows that the four points of tangency, $\overline{Q_1P^*}$  is perpendicular to $\overline{C_1Q_1}$, and are therefore the  transition points.  
