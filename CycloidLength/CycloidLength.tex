...
To see why, let's focus our attention on this second trammel. With the coordinate system of Figure ?? and $\phi$ the marked angle the arm makes with the $x$-axis, the tracing point has coordinates 
\[
     (x,y) = ((b+a)\cos\phi, (b-a)\sin\phi) , 0\leq \phi <2\pi. 
\]
This shows $P^*$ sweeps out an ellipse. To find the arm's position when it is tangent to the ellipse, imagine the arm in motion. Then the arm is tangent to the ellipse exactly when $P^*$ moves parallel to the arm, or when $dy/dx = -\tan\phi$. Some calculus and algebra then shows
\[
...
\begin{onlineOnly}
    \begin{center}
\desmos{yjbbemqlsk}{900}{600}   %yfoczp8y2g
\end{center}
\end{onlineOnly}

\href{https://www.desmos.com/calculator/yjbbemqlsk}{Double Generation Ellipse 3}
