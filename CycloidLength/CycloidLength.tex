...
Robinson's third arclength theorem is about ellipses. When a circle ${\cal C}_1$ with radius $a$ rolls around the \emph{inside} of a circle ${\cal C}_1^\prime$ with radius $2a$, a point $P^*$, $b$ units from the center of ${\cal C}_1$, traces an ellipse with major and minor semi-axes $b+a$ and $b-a$ (Figure ??). As ${\cal C}_1$ rolls once round ${\cal C}_1^\prime$, the point $P_1$ (on ${\cal C}_1$) doubly traces the horizontal diameter of ${\cal C}_1^\prime$. Our theorem for prolate hypocycloids then implies the same-side arclength (red) of the ellipse exceeds its opposite-side length (blue) by $4a$, twice the diameter of ${\cal C}_1^\prime$. Figure ?? shows $P^*$ at a transition point where it crosses the rolling tangent.
