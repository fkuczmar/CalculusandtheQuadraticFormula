...
\newtheorem{theorem19}{Robinson's Arclength Theorem for Prolate Cycloids, Generalized}
...
Carpenters on occasion
 use the trammel of Archimedes to draw an ellipse.
\begin{center}  
...
The trammel of Archimedes hides in Figure ??, repeated here below. As ${\cal C}_1$ rolls around ${\cal C}_2$, the endpoints of the diameter $\overline{PR}$ through the tracing point slide along perpendicular lines. This is exactly what we need to understand the transition points.

Well not quite. When the tracing point lies on the extension of $\overline{PR}$ as it does here, $\overline{PR}$ is \emph{never} tangent to the ellipse. It is only when $P^*$ lies on $\overline{PR}$ that $\overline{PR}$ is ever tangent to the ellipse. 
