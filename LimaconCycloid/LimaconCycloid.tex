...
\newtheorem{theorem9}{Robinson's Arclength Theorem for Cycloids Generalized}
...
\begin{onlineOnly}
    \begin{center}
\desmos{7qhymuu03y}{900}{600}   
\end{center}
\end{onlineOnly}

\href{https://www.desmos.com/calculator/7qhymuu03y}{Curtate Cycloid Arclength 2}
...
\[
    \phi^* = \arcsin\left( \frac{a}{b}\sin\phi \right) .
\]
