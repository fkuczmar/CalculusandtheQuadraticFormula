...
\begin{theorem9}
As in Figure 1 with $s_1 = s_1(\phi)$ and $s_2=s_2(\phi)$ the respective arclengths of a prolate cycloid above and below the $x$-axis between inclination angles $0$ and $\phi$, and $s_3=s_3(\phi)$ the arclength of the ordinary cycloid between these same angles,
\[
s_1 - s_2 = s_3.
\]
\end{theorem9}
...
\]
along the cardioid equal to twice the differential arclength $ds$ along the cycloid. And if, as illustrated in Figure 4, we measure the incination angle $\phi$ of the cardioid \emph{relative to the rolling tangent line}, then $ds^* = 2\, ds$ between inclination angles $\phi$ and $\phi + d\phi$ of the two curves.
