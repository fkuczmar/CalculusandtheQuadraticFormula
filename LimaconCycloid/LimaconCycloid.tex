...
It would be a mistake (one that I made) to think the equality of distances
\[
   \rho_1 - \rho_2 = \rho_3 ,
\]
implied the equality of differential arclengths above. But since the circles in Figure 3 turn through different differential angles in sweeping out the differential arclengths because in sweeping out the full curves (upper, lower limacon, and cycloid) the circles turn through the unequal angles 
\[
      (\Delta \theta_1 = 2\pi) > (\Delta \theta_1 = 2\arccos(-a/b)) > (\Delta \theta_3 = 2\pi - 2\arccos(-a/b) ) . 
\]
So the correpsonding differential angles $d\theta_i$ are generally not equal and we need to find some relationships among them to show the equality
\[
       \rho_1 \, d\theta_1 - \rho_2 \, d\theta_2 = \rho_3 \, d\theta_3
\]
of differential arclengths.
